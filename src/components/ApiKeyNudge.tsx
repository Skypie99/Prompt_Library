...
export function ApiKeyNudge({ onOpenSettings, onDismiss }: ApiKeyNudgeProps) {
  return (
    <div
      role="status"
      className="border-b border-teal-200 bg-teal-50 px-6 py-3 text-sm text-teal-900 dark:border-teal-500/40 dark:bg-teal-500/10 dark:text-teal-100"
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4">
        <span>
          ...
          <button
            ...
            className="font-medium underline underline-offset-2 hover:text-teal-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-50 dark:hover:text-teal-200 dark:focus-visible:ring-offset-night"
          >
            Open Settings
          </button>
        </span>

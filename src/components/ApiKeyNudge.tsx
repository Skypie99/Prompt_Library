...
export function ApiKeyNudge({ onOpenSettings, onDismiss }: ApiKeyNudgeProps) {
  return (
    <div
      role="status"
      className="border-b border-coral-200 bg-coral-50 px-6 py-3 text-sm text-coral-900 dark:border-coral-500/40 dark:bg-coral-500/10 dark:text-coral-100"
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4">
        <span>
          ...
          <button
            ...
            className="font-medium underline underline-offset-2 hover:text-coral-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral-500 focus-visible:ring-offset-2 focus-visible:ring-offset-coral-50 dark:hover:text-coral-200 dark:focus-visible:ring-offset-night"
          >
            Open Settings
          </button>
        </span>
